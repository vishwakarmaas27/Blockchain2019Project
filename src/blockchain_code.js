 ...
 class Blockchain
{
    constructor() 
    {
      this.blockchainName = "Ice-cream";    //this.getBlockchainName();
      this.difficulty = 1;
...
//Tamper Code, Recalculate its hash, to make everything appear to be in order
myBlockchain.chain[1].data = {loc: "Jaipur" , status: "Shipment Loaded."};
